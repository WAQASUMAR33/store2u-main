  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="flex items-center justify-between mb-4">
        <span className="text-orange-500 font-bold uppercase tracking-widest text-sm">On Sale Now</span>
        ...
        <button className="text-orange-500 border border-orange-500 px-6 py-2 rounded-full font-black text-[10px] uppercase tracking-widest hover:bg-orange-500 hover:text-white transition-all shadow-lg active:scale-95 shadow-orange-500/10">Shop More</button>
      </div>
